  ...
  $.ajax({
		...
		success: function(msg) {
			$("#message-box").removeClass();
					...
					document.getElementById("orderope").disabled=true;
		}
	});
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <td>${productlist.amount}</td>
                 ...
                 <tr>
                 <td colspan="8"><button id="orderope" class="btn btn-primary" onclick="addmsg(${orderid},${out})">开备货单/缺货单</button><button class="btn btn-default" onclick="back();">返回</button></td>
