...
strXML = "<graph   decimalPrecision='0' showNames='1' numberSuffix=' Units' pieSliceDepth='30' formatNumberScale='0'>";
...
//    factoryId=rs1.getString("FactoryId");
    byte[] b = rs1.getBytes("Time");
    Name=new String (b, "UTF-8");
    Amount=rs1.getString("TotalAmount");
