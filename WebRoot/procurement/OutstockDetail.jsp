  ...
  $.ajax({
		...
		success: function(msg) {
			$("#message-box").removeClass();
			 ...
			 document.getElementById("admitoutstock").disabled=true;
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <td>${outstockdetail.outstocknum}</td>
                 ...
                 <tr class="noprint">
                <td colspan="3"><button class="btn btn-primary" onclick="javascript:window.print();">打印采购单</button></td><td colspan="3"> <button id="admitoutstock" class="btn btn-primary" onclick="admitmsg(${outstockid})">采购确认</button><button class="btn btn-default" onclick="back();">返回</button></td>
                </tr>
              </tbody>
            </table>
