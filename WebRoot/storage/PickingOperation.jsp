            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <td>${pickingdetail.pickingdetailnum}</td>     
                 ...
                 <tr class="noprint">
                <td colspan="3"><button class="btn btn-primary" onclick="javascript:window.print();">打印发货单</button></td> <td colspan="3"> <button class="btn btn-primary" onclick="admitmsg(${pickingid})">发货确认</button></td>
                </tr>
              </tbody>
            </table>
