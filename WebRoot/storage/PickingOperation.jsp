  ...
  $.ajax({
		...
		success: function(msg) {
			$("#message-box").removeClass();
					...
					document.getElementById("admitout").disabled=true;
...
.noprint{display : none }  
  ...
  <body onload="onload()">
          ...
          <h1  class="noprint">库存管理-备货单详情</h1>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <td>${pickingdetail.pickingdetailnum}</td>     
                 ...
                 <tr class="noprint">
                <td colspan="3"><button class="btn btn-primary" onclick="javascript:window.print();">打印发货单</button></td> <td colspan="3"> <button id="admitout" class="btn btn-primary" onclick="admitmsg(${pickingid})">发货确认</button><button class="btn btn-default" onclick="back();">返回</button></td>
                </tr>
              </tbody>
            </table>
