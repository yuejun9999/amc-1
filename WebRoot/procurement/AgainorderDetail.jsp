            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <td>${againorderdetail.productqua}</td>
                 ...
                 <tr class="noprint">
                <td colspan="3"><button class="btn btn-primary" onclick="javascript:window.print();">打印再订货单</button></td><td colspan="3"><button class="btn btn-primary" onclick="admitmsg(${againorderid})">采购确认</button></td>
                </tr>
              </tbody>
            </table>
